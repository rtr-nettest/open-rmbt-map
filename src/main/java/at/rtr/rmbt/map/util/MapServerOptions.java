            ...
            put("operator", new MapFilter()
            {
                ...
                public SQLFilter getFilter(final String input)
                {
                    ...
                    if (input.equals("other"))
                        ...
                        {
                            @Override
                            public int fillParams(int i, final Query ps) throws SQLException
                            {
                                ps.setParameter(i++, Integer.parseInt(input));
                                return i;
                            }
                        };
                }
                ...
                public SQLFilter getFilter(final String input)
                {
                    ...
                    try
                    {
                        ...
                        return new SQLFilter("t.time > NOW() - CAST(? AS INTERVAL)")
                        {
                            ...
                            public int fillParams(int i, final Query ps) throws SQLException
                            {
                                ps.setParameter(i++, String.format("%d days", period));
                                return i;
                            }
                        };
                    }
                ...
                public SQLFilter getFilter(final String input)
                {
                    ...
                    try
                    {
                        ...
                        return new SQLFilter("t.time < NOW() - CAST(? AS INTERVAL)")
                        {
                            ...
                            public int fillParams(int i, final Query ps) throws SQLException
                            {
                                ps.setParameter(i++, String.format("%d days", age));
                                return i;
                            }
                        };
                    }
            ...
            put("user_server_selection", new MapFilter()
            {
                ...
                {            	
        			return new SQLFilter("t.user_server_selection = ?") {
        				...
        				public int fillParams(int i, final Query ps) throws SQLException
        				{
        					ps.setParameter(i++, Boolean.valueOf(input));
        					return i;
        				}
        			};
                }
...
//            });
    ...
    public static class SQLFilter
    {
        ...
        public int fillParams(final int i, final Query ps) throws SQLException
        {
            return i;
        }
